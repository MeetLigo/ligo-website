...
export function AdvisorsSection() {
  ...
  return (
    <section className="border-t border-[#D7CCBC]/[0.08] bg-[#171717] px-6 pb-16 pt-12 sm:px-10 sm:pb-20 sm:pt-14">
      <div className="mx-auto max-w-[1100px] text-center">
        <div className="text-[11px] font-bold uppercase tracking-eyebrow text-[#F97316]">advisors &amp; backers</div>
        <h2 className="mt-3 font-serif text-[26px] font-semibold tracking-[-0.01em] text-[#FAF6EF]">
          In our corner.
        </h2>
