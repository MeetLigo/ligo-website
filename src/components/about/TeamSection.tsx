...
export function TeamSection() {
  return (
    <section
      ...
      style={{ background: "linear-gradient(180deg,#171717,#1B150E 55%,#171717)" }}
    >
      <div className="mx-auto max-w-[1100px]">
        <div className="text-center">
          <div className="text-[11px] font-bold uppercase tracking-eyebrow text-[#F97316]">the team</div>
          <h2 className="mt-3 font-serif text-section-title font-semibold text-[#FAF6EF]">The people building it.</h2>
        </div>
