...
// movie night, dance team, club booth, friends selfie, speaker event.
// Per-slide crop keeps the PEOPLE in frame, not sky/screens.
const SLIDES = ["/hero/slide-1.jpg", "/hero/slide-2.jpg", "/hero/slide-3.jpg", "/hero/slide-4.jpg", "/hero/slide-5.jpg"];
const SLIDE_POS = ["center 72%", "center 45%", "center 45%", "center 55%", "center 62%"];
const SLIDE_MS = 4000;
